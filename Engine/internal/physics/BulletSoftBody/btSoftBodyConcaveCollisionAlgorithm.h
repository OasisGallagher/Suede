...
#include "internal/physics/BulletCollision/BroadphaseCollision/btDispatcher.h"
...
#include "internal/physics/BulletCollision/NarrowPhaseCollision/btPersistentManifold.h"
class btDispatcher;
#include "internal/physics/BulletCollision/BroadphaseCollision/btBroadphaseProxy.h"
#include "internal/physics/BulletCollision/CollisionDispatch/btCollisionCreateFunc.h"
class btSoftBody;
class btCollisionShape;

#include "internal/physics/LinearMath/btHashMap.h"

#include "internal/physics/BulletCollision/BroadphaseCollision/btQuantizedBvh.h" //for definition of MAX_NUM_PARTS_IN_BITS
