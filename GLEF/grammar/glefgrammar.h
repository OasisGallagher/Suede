...
"\n"
"$PropertiesPrefix\n"
"	: $PropertiesPrefix $Property			$$ = merge(\"Properties\", $2, $1)\n"
"	| $Property								$$ = $1\n"
"\n"
"$Property\n"
...
"\n"
"$SubShadersPrefix\n"
"	: $SubShadersPrefix $SubShader		$$ = merge(\"SubShaders\", $2, $1)\n"
"	| $SubShader						$$ = $1\n"
"\n"
"$SubShader\n"
...
"\n"
"$PassesPrefix\n"
"	: $PassesPrefix $Pass		$$ = merge(\"Passes\", $2, $1)\n"
"	| $Pass						$$ = $1\n"
"\n"
"$Pass\n"
...
"\n"
"$RenderStatesPrefix\n"
"	: $RenderStatesPrefix $RenderState	$$ = merge(\"RenderStates\", $2, $1)\n"
"	| $RenderState						$$ = $1\n"
"\n"
"$RenderState\n"
